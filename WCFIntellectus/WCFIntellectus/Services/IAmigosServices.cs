...
namespace WCFIntellectus.Services
{
    ...
    public interface IAmigosServices
    {
        ...
        [OperationContract]
        Utileria.ActualizarRespuesta<Entidades.SolicitudAmistad> AceptarSolicitud(int idsolicitudamistad);
        [OperationContract]
        Utileria.MultipleRespuesta<Entidades.SolicitudAmistad> ConsultarAmigos(int solicitante);
    }
}
